 ...
 * @author ASUS
 */
public class PayableLoans extends javax.swing.JFrame {
    ...
    private void setPayableLoans() {
        try {
            ArrayList<Loan> payableLoans = LoanController.getPayableLoans();
            for (Loan loan : payableLoans) {
                ...
                Object[] rawData = {loan.getLoanId(), loan.getDate(), loan.getEmployeeId(), employee.getFirstName() + " " + employee.getSecondName(), Double.toString(loan.getLoanAmount())+0, Double.toString(installedAmount)+0, Double.toString(relatedAmount)+0, loan.getDueDate()};
                dtm.addRow(rawData);
            }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("released loans");
        ...
        jLabel12.setText("released loans");
        ...
        getContentPane().add(jLabel69, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 660, 120, 30));
        ...
        getContentPane().add(jLabel70, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 660, 120, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "loanID", "date", "employeeID", "name", "loan amount", "installed amount", "related amount", "due date"
            }
        ));
    ...
    private void jLabel69MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel69MouseExited
        ...
        jLabel69.setVisible(false);// TODO add your handling code here:
    ...
    private void jLabel70MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel70MouseEntered
        ...
        jLabel70.setVisible(false);// TODO add your handling code here:
    ...
    private void jLabel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel15MouseClicked
        this.dispose();
        new ReleasedLoans().setVisible(true);// TODO add your handling code here:
    ...
    private void jLabel69MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel69MouseClicked
        try {
            InputStream is = getClass().getResourceAsStream("payableLoans.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayableLoans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
